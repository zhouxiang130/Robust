...
import com.yj.robust.model.LogicalDetailEntity;
import com.yj.robust.ui.adapter.MineLogicalDetailAdapter;
...
//      setTitleLeftImg();
    ...
    private void doAsyncGetData() {
        ...
        OkHttpUtils.post().url(URLBuilder.URLBaseHeader + "/phone/user/express.act")
