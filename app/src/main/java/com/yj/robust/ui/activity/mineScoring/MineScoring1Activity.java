package com.yj.robust.ui.activity.mineScoring;
...
import com.yj.robust.ui.activity.MineScoringAccordActivity;
import com.yj.robust.ui.activity.MineScoringPostActivity;
import com.yj.robust.ui.activity.NormalWebViewActivity;
import com.yj.robust.ui.adapter.MineOrderTabAdapter;
import com.yj.robust.ui.fragment.MineScoringAccord.MineScoringAccordFrag;
...
//		tvContent.setText(R.string.integral_content);
	...
	private void doAsyncGetData() {
		...
		OkHttpUtils.post().url(URLBuilder.URLBaseHeader + "/phone/user/zoneOrder.act").tag(this)
