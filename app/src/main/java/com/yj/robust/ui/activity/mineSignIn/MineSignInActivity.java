...
import com.yj.robust.widget.MyLayoutManager;
...
//		map.put("userId", "18");
		...
		OkHttpUtils.post().url(URLBuilder.URLBaseHeader + "/phone/userUp/searchUserSign.act").tag(this)
...
//		map.put("userId", "18");
		LogUtils.i("传输的值" + URLBuilder.format(map));
		OkHttpUtils.post().url(URLBuilder.URLBaseHeader + "/phone/userUp/signUser.act").tag(this)
				.addParams(Key.data, URLBuilder.format(map))
