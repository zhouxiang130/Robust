package com.yj.robust.ui.fragment;
...
import com.yj.robust.model.ClassifyContentEntity;
import com.yj.robust.model.ClassifyEntity;
import com.yj.robust.ui.activity.SearchActivity;
import com.yj.robust.ui.adapter.ClassifyContentAdapter;
import com.yj.robust.ui.adapter.ClassifyTitleAdapter;
...
//		contentRecyclerView.setLayoutManager(contentLayoutManager);
	...
	private void doAsyncGetTitle() {
		...
		OkHttpUtils.post().url(URLBuilder.URLBaseHeader + "/phone/homePage/productClassifyList.act")
			...
			public void onResponse(ClassifyEntity response) {
				if (response != null && response.getCode().equals(response.HTTP_OK)) {
					//返回值为200 说明请求成功
					if (response.getData() != null && response.getData().getProductClassifyList() != null) {
	...
	private void doAsyncGetContent(final String classifyId) {
		...
		OkHttpUtils.post().url(URLBuilder.URLBaseHeader + "/phone/homePage/productClassifyByParIdList.act")
