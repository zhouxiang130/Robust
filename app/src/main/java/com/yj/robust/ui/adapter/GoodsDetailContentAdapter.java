...
//                ((CouponReceiveHolder) holder).llYes.setVisibility(View.GONE);
            ...
            if (data != null && !TextUtils.isEmpty(data.getProductUrl())) {
                ((JudgeViewHolder) holder).WebViews.loadUrl(URLBuilder.getUrl(data.getProductUrl()));
            }
    ...
    class JudgeViewHolder extends RecyclerView.ViewHolder {
        ...
        com.yj.robust.widget.mWebView WebViews;
