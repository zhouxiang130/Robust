package com.yj.robust.ui.activity.mineHelpSug;
...
import com.yj.robust.model.HelpSugEntity;
import com.yj.robust.model.JudgeGoodsData;
import com.yj.robust.model.NormalEntity;
import com.yj.robust.ui.adapter.MineHelpSugAdapter;
...
import com.yj.robust.widget.JsonUtils;
...
//                            showImg();
	...
	private void doAsyncPost(int judgeType, String judgeContent) {
		...
		LogUtils.i("im");
		params = OkhttpFileUtils.post().url(URLBuilder.URLBaseHeader + "/phone/userUp/userFeedback.act")
