...
import com.yj.robust.model.InfoCenterEntity;
import com.yj.robust.ui.adapter.InfoCenterAdapter;
...
//      setTitleLeftImg();
	...
	private void doRefreshData() {
		...
		OkHttpUtils.post().url(URLBuilder.URLBaseHeader + "/phone/user/searchMessage.act")
