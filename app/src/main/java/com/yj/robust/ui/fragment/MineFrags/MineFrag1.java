...
import com.yj.robust.ui.activity.MineAboutActivity;
...
import com.yj.robust.ui.activity.mineSignIn.MineSignInActivity;
...
public class MineFrag1 extends BaseFragment implements MineFrag_contract.View {
	...
	@OnClick({R.id.frag_mine_info, /*R.id.frag_mine_login_iv,*/ R.id.frag_mine_login_,/* R.id.frag_mine_head_img,*/ R.id.frag_mine_login_ll, R.id.frag_mine_account, R.id.frag_mine_scoring,
			...
			R.id.frag_mine_invite, R.id.frag_mine_collection, R.id.frag_mine_address, R.id.frag_mine_signIn, R.id.frag_mine_ticket, R.id.frag_mine_coustom_service, R.id.frag_mine_contact,
