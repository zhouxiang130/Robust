...
import com.yj.robust.ui.fragment.CartFrag.CartFrag;
import com.yj.robust.ui.fragment.ClassifyFrag;
import com.yj.robust.ui.fragment.HomeFrag.HomeFrag;
import com.yj.robust.ui.fragment.MineFrags.MineFrag1;
...
import static com.yj.robust.util.PermissionUtils.READ_EXTERNAL_STORAGE;
import static com.yj.robust.util.PermissionUtils.REQUEST_CODE_READ_PHONE_STATE;
...
//	TextView tvStore;
    ...
    private Fragment mHomepage, mClassify, mCart, mMine1 /*mMine,mStore*/;
    ...
    protected void initView() {
        ...
        mTextView = new TextView[]{tvHomepage, tvClassify, tvCart, tvMine};//tvStore
...
//		mMine1 = new MineFrags();
    ...
    private void AsynUserLuck() {
        ...
        OkHttpUtils.post().url(URLBuilder.URLBaseHeader + "/phone/user/searchUserLock.act").tag(this)
    ...
    private void initFragment() {
        mFragments = new Fragment[]{mHomepage, mClassify, mCart, mMine1};
...
//				.addToBackStack(null)
                ...
                .show(mHomepage)
                .commit();
        mManager.beginTransaction().hide(mClassify).hide(mCart).hide(mMine1).commitAllowingStateLoss();
        mCurrent = mHomepage;
        if (mPage != 0) {
            selected(mPage);
        }
...
//            ToastUtils.custom("再按一次退出程序!");
            ToastUtils.showToast(this, "再按一次退出好新优!");
            tExit = new Timer();
