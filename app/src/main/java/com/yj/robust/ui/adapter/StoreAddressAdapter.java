...
public class StoreAddressAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
	...
	public StoreAddressAdapter(Context mContext, List<AddressEntity.AddressData.AddressList> mList, UserUtils mUtils, String locCity) {
	...
	public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
		if (holder instanceof AddressTitleViewHolder) {
			...
			((AddressInfoViewHolder) holder).tvAddress.setText(mList.get(position - 3).getAddressArea() + mList.get(position - 3).getAddressAreaDetail());
		}
	}
