...
import com.yj.robust.listener.JudgeCompressListener;
import com.yj.robust.model.JudgeGoodsData;
import com.yj.robust.model.JudgeGoodsDataEntity;
import com.yj.robust.model.NormalEntity;
import com.yj.robust.ui.adapter.PostJudgeGoodsAdapter;
import com.yj.robust.util.LogUtils;
import com.yj.robust.util.OkhttpFileUtils;
...
//                            showImg();
    ...
    private void doAsyncGetData() {
        ...
        OkHttpUtils.post().url(URLBuilder.URLBaseHeader + "/phone/user/toProComment.act")
    ...
    private void doAsyncPost(){
        ...
        for(int i = 0;i<entity.size();i++){
            for(int x = 0;x<entity.get(i).getmImage().size();x++){
                LogUtils.i("图片的路径为"+i+"......x"+x+"....path"+entity.get(i).getmImage().get(x).getAbsolutePath());
            }
        ...
        LogUtils.i("im");
        params = OkhttpFileUtils.post().url(URLBuilder.URLBaseHeader + "/phone/user/productAppraise.act")
                .addParams("data", URLBuilder.format(map))
