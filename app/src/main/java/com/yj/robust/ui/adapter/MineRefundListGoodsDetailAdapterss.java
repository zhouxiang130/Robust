...
public class MineRefundListGoodsDetailAdapterss extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
	...
	public MineRefundListGoodsDetailAdapterss(Context context, List<CartsEntity.DataBean.ProCartsBean.ShopProArrayBean> data, int pos, boolean isShow, String receipt) {
