...
import com.yj.robust.model.AccountCostEntity;
import com.yj.robust.ui.activity.MineAccountCostDetialActivity;
import com.yj.robust.ui.adapter.AccountCostAdapter;
...
public class MineAccountCostFrag extends LazyLoadFragment {
	...
	private void doRefreshData() {
		...
		OkHttpUtils.post().url(URLBuilder.URLBaseHeader + "/phone/user/backMoneys.act").tag(this)
