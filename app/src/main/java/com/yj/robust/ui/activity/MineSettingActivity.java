...
import com.yj.robust.model.UpdateEntity;
import com.yj.robust.service.DownAPKService;
import com.yj.robust.ui.MainActivity;
import com.yj.robust.ui.activity.mineSettingHelp.MineSettingHelpActivity;
import com.yj.robust.util.CacheUtils;
...
import com.yj.robust.util.VersionUtils;
import com.yj.robust.widget.Dialog.CustomNormalDialog;
import com.yj.robust.widget.Dialog.UpdateDialog;
import com.yj.robust.widget.SwitchView;
...
//							preferencesUtil.setValue("userType", "");
	...
	private void doAsyncTaskUpdate() {
		OkHttpUtils.post()
				.url(URLBuilder.URLBaseHeader + "/phone/user/appVersion.act")
				.tag(this)
				.build()
