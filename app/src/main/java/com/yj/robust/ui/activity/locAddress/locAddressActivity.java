package com.yj.robust.ui.activity.locAddress;
...
import com.yj.robust.ui.adapter.StoreAddressAdapter;
...
//				}
				...
				String addressAreaDetail = mList.get(position - 4).getAddressAreaDetail();
...
//		mAdapter.notifyDataSetChanged();
	...
	private void setLocInfo() {
		instance = LocationUtil.getInstance(locAddressActivity.this);
		instance.isOpenGPS();
		AMapLocation aMapLocation = instance.getAMapLocation(locAddressActivity.this);
