...
import com.yj.robust.util.InstallUtil;
...
//					.setProgress(PROGRESS_MAX, progress, false);
			...
			builder1.setTicker("好新优开始下载");
			builder1.setContentTitle("好新优"); //设置标题
