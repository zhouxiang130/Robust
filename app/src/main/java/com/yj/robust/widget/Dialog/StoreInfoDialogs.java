...
import com.yj.robust.ui.adapter.StoreTelAdapter;
import com.yj.robust.util.AuthorUtils;
import com.yj.robust.widget.MTextView;
...
public class StoreInfoDialogs extends Dialog {
	...
	public void setCustomDialog(final ShopDetailEntity datas, int i) {
		...
		if (i == 1) {
			...
			tvServicesContent.setText(datas.getData().getShopService());
			...
			tvServicesContent2.setText("起送： " + datas.getData().getServiceStartime() + "\n" + "配送时间： " + datas.getData().getServiceTime());
