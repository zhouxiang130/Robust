...
import com.yj.robust.ui.adapter.TicketDialogAdapter;
...
public class GoodDetailTicketDialogs extends Dialog {
	...
	public void setCustomDialog(int type, GoodsEntity.GoodsData goodsData, String uid) {
		...
		if (type == 2) {
			tvTitle.setText("积分");
			tvIntegral.setText("购买可得" + goodsData.getConsumerBackscore() + "积分");
